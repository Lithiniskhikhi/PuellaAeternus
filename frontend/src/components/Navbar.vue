        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <header id="header">
            <ul class="navbar-nav" mx-auto p-2>
              <li class="nav-item">
                <router-link class="nav-link" to="/" style="color:#000"></router-link>
              </li>
              <li class="nav-item">
                <router-link class="nav-link" to="/" style="color:#000">HOME</router-link>
              </li>
              <li class="nav-item">
                <router-link class="nav-link" to="/about" style="color:#000">ABOUT</router-link>
              </li>
              <li class="nav-item">
...
.nav-link:active {
  ...
  color: blue; /* Set the link color to blue when active */
}
...
nav a.router-link-exact-active,
  .li.active {
    text-shadow: 3px 1px 5px rgba(39, 29, 179, 0.92) !important;
  }
